...
#' glm_optimization$performance_metric <- metric("AUC_roc")
...
#' knn_optimization$performance_metric_args <- list(pos_level = 2)
#' knn_optimization$performance_metric <- metric("AUC_roc")
#'
#' # set data

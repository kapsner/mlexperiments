...
More details on the package [`rBayesianOptimization`](https://cran.r-project.org/package=rBayesianOptimization) and on how to define the Bayesian scoring function can be found in its [documentation](https://cran.r-project.org/web/packages/rBayesianOptimization/refman/rBayesianOptimization.html).
